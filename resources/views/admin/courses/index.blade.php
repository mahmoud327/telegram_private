                        ...
                        <tbody>
                            @foreach ($courses as $course)
                                <tr>
                                    ...
                                    <td>{{ $course->title }}</td>
                                    <td>{{ optional($course->material)->name }}</td>
                                    <td>
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-toggle="modal" href="#exampleModal2{{ $course->id }}"
                                            title="edit"><i class="las la-pen"></i></a>

                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-toggle="modal" href="#modaldemo9{{ $course->id }}" title="delete"><i
                                                class="las la-trash"></i></a>

                                    </td>
                                </tr>

                                @include('admin.courses.delete_modal', ['course' => $course])
                                @include('admin.courses.edit_modal', ['course' => $course])
                            @endforeach
                        </tbody>
                    </table>
                    {{ $courses->links() }}
...
@include('admin.courses.add_modal')
